...
def admin_dashboard():
    ...
    return render_template('admin_dashboard.html', users=users, books=books, borrows=all_borrows, active_filter_id=user_filter_id)
...
def user_dashboard():
    ...
    return render_template('user_dashboard.html', books=books, borrows=my_borrows, search=query, total_fine=total_fine)
